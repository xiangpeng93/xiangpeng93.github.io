        ...
        <el-container>
            ...
            <el-container>
                ...
                <el-main style="height:85vh">
                    <el-table :data="RewardData.filter(data => data.name.toLowerCase().includes(searchName.toLowerCase()) &&data.proj.toLowerCase().includes(searchDepartment.toLowerCase()))" :span-method="arraySpanMethod" :row-class-name="tableRowClassName" border style="width: 100%" v-loading="loading">
                        ...
                        <el-table-column prop="position" label="事件发生地点">
                        </el-table-column>
